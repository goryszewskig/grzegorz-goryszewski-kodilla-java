...
public class BookDirectoryTestSuite {
    ...
    @Test
    public void testListBooksInHandsIfNone() {
        // Given
        ...
        //When
        List<Book> theListOfBorrowedBooks = bookLibrary.listBooksInHandsOf(new LibraryUser("Grzegorz", "Goryszewski", "123456"));
    ...
    @Test
    public void testListBooksInHandsIfOne() {
        // Given
        List<Book> resultListOfBooks = generateListOfNBooks(1);
        when(libraryDatabaseMock.listBooksInHandsOf(isA(LibraryUser.class))).thenReturn(resultListOfBooks);

        //When
        List<Book> theListOfBorrowedBooksByUserWhoHave1Books = bookLibrary.listBooksInHandsOf(new LibraryUser("Grzegorz", "Goryszewski", "123456"));
    ...
    @Test
    public void testListBooksInHandsIfFive() {
        // Given
        List<Book> resultListOfBooks = generateListOfNBooks(5);
        when(libraryDatabaseMock.listBooksInHandsOf(isA(LibraryUser.class))).thenReturn(resultListOfBooks);

        //When
        List<Book> theListOfBorrowedBooksByUserWhoHave5Books = bookLibrary.listBooksInHandsOf(new LibraryUser("Grzegorz", "NoGoryszewskiwak", "123456"));
